...
export default function Hero() {
    return (
        <section className=" section-l-p section-r-p relative overflow-hidden">
            <div
                aria-hidden="true"
                className="gradient-bg absolute top-5 lg:top-10 -right-70 w-100 h-90 md:w-130 md:h-110 rounded-full blur-3xl opacity-50"
            />
            <div className="mx-auto py-15 pt-20 lg:pt-52 relative z-10">
                ...
                <div className="mt-16 lg:mt-18 w-full bg-[url('/herobg.jpg')] bg-cover bg-center h-[90vh] lg:h-[70vh] rounded-bl-2xl lg:rounded-bl-4xl rounded-br-[5rem] lg:rounded-br-[10rem] rounded-tl-[5rem] lg:rounded-tl-[10rem] rounded-tr-2xl lg:rounded-tr-4xl ">
                </div>
            </div>
        </section>
    );
