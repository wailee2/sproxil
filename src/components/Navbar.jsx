                ...
                >
                    <div className=" mx-auto p-4 gap-4 w-full h-full flex flex-col sm:flex-row min-h-0 overflow-y-auto">
                        <motion.div
                            ...
                            className="bg-white py-4 px-8 sm:px-10 sm:w-1/2 h-1/2 sm:h-full rounded-2xl flex flex-col justify-between min-h-0 overflow-auto"
                            data-lenis-prevent
                        >
                        ...
                        <div className="flex flex-col sm:w-1/2 h-1/2 sm:h-full gap-4 min-h-0">
                            <motion.div
                                initial={{ y: 100, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}
                                exit={{ y: 300, opacity: 0}}
                                transition={{ duration: 1.5, delay: 0, ease: "easeInOut" }}
                                className="bg-white flex flex-col justify-between py-4 px-8 sm:px-14 md:px-20 rounded-2xl w-full h-full min-h-0n overflow-auto"
                                data-lenis-prevent
                            >
